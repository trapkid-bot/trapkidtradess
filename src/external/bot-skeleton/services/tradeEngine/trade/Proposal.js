    ...
    class Proposal extends Engine {
        makeProposals(trade_option) {
            ...
            const analyzerActive =
                ...
                ['COMMAND_RECEIVED', 'COMMAND_ACCEPTED', 'ANALYZER_DATA_BOUND', 'WAITING_FOR_ANALYZER_EXIT', 'ANALYZER_EXECUTION', 'ANALYZER_TRADE_LOCKED', 'EARLY_EXIT_COMMAND_RECEIVED', 'RUNNING', 'ANALYZER_PURCHASE_AUTHORIZED', 'ANALYZER_PURCHASE_BOUND'].includes(
